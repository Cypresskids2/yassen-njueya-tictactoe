...
function gameplay(){    //function definition
    buttonList.forEach(button => {  //arrow function ~ lambda expression
        button.onclick = () => {
...
function checkWin(){
    if(
        ...
        button1.textContent.trim() == "X" && button4.textContent.trim() == "X" && button7.textContent.trim() == "X" || //X Horizontal
    ...
    if(
        ...
        button1.textContent.trim() == "O" && button4.textContent.trim() == "O" && button7.textContent.trim() == "O" || //X Horizontal
